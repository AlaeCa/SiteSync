...
export default function ProfileScreen({ navigation }: any) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <TouchableOpacity style={styles.adminButton} onPress={() => navigation.navigate('Dashboard')}>
        <Text style={styles.adminButtonText}>Tableau de bord Admin</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.notificationsButton} onPress={() => navigation.navigate('Notifications')}>
...
const styles = StyleSheet.create({
  ...
  adminButton: {
    backgroundColor: '#ff6b35', marginHorizontal: 16, marginTop: 16,
    borderRadius: 12, padding: 16, alignItems: 'center'
  },
  adminButtonText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  notificationsButton: {
    backgroundColor: '#16213e', marginHorizontal: 16, marginTop: 12,
    borderRadius: 12, padding: 16, alignItems: 'center', borderWidth: 1, borderColor: '#0f3460'
  },
  notificationsButtonText: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  logoutButton: {
